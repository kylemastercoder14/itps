          ...
          <Card className="rounded-xl border-zinc-200 px-5 py-4 shadow-xs">
            ...
            <div className="flex flex-wrap justify-between gap-3">
              <div className="relative min-w-72">
                <Input
                  className="h-9 text-xs! bg-transparent border-input pr-10"
...
function PageHeader() {
  return (
    <div className="flex flex-wrap items-start justify-between gap-3">
      ...
      <Button
        asChild
        className="rounded-lg text-xs bg-zinc-900 text-white hover:bg-zinc-800"
      >
        <Link href="/admin/users/roles/create">Add Role</Link>
      </Button>
    </div>
  );
}
...
function RolesList() {
  return (
    <Card className="rounded-xl border-zinc-200 h-fit px-5 py-4 shadow-xs">
      ...
      <p className="text-xs text-slate-500">Showing 1 to 7 of 7 roles</p>
    </Card>
  );
}
      ...
      <Table>
        ...
        <TableBody>
          ...
          {ROLE_COLLAPSED_MODULES.map((module) => (
            <TableRow key={module} className="bg-zinc-50/70">
              <TableCell colSpan={6} className="font-bold">
                {module}
              </TableCell>
            </TableRow>
...
function RoleSummary() {
  const total = USER_ROLE_DISTRIBUTION.reduce(
      ...
      <div className="flex gap-3">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-blue-700">
            Learn more about roles and permissions and how to manage access
            control.
          </p>
